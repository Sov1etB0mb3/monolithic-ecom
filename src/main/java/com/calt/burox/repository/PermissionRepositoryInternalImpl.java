...
/**
 * Spring Data R2DBC custom repository implementation for the Permission entity.
 */
@SuppressWarnings("unused")
class PermissionRepositoryInternalImpl extends SimpleR2dbcRepository<Permission, Long> implements PermissionRepositoryInternal {
