...
export class RoleService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/roles/_search');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IRole[]>()], asapScheduler)));
  }
