...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.calt.burox.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.calt.burox.security.DomainUserDetailsService", "createSpringSecurityUser");
