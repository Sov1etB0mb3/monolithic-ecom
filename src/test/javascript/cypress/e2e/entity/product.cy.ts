...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'finding long-term father', quantity: 10669, price: 30313.06 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('optimistically aside');
      cy.get(`[data-cy="name"]`).should('have.value', 'optimistically aside');

      cy.get(`[data-cy="quantity"]`).type('10377');
      cy.get(`[data-cy="quantity"]`).should('have.value', '10377');

      cy.get(`[data-cy="price"]`).type('20992.69');
      cy.get(`[data-cy="price"]`).should('have.value', '20992.69');

      cy.get(`[data-cy="createdAt"]`).type('2026-03-31T17:29');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2026-03-31T17:29');

      cy.get(`[data-cy="updatedAt"]`).type('2026-03-31T22:08');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2026-03-31T22:08');
