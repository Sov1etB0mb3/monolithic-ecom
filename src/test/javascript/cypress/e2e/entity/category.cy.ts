...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'taro makeover' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('insistent');
      cy.get(`[data-cy="name"]`).should('have.value', 'insistent');

      cy.get(`[data-cy="description"]`).type('swat');
      cy.get(`[data-cy="description"]`).should('have.value', 'swat');

      cy.get(`[data-cy="createdAt"]`).type('2026-03-31T20:16');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2026-03-31T20:16');

      cy.get(`[data-cy="updatedAt"]`).type('2026-03-31T14:50');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2026-03-31T14:50');
